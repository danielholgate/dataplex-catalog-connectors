...
To create an end-to-end pipeline which runs the synchronous metadata extraction by the connector and then submits an import job, monitoring the async import process into universal catalog, see the section below [create-an-end-to-end-metadata-extraction-and-import-pipeline-to-universal-catalog]
