...
This custom connector extracts metadata from Snowflake to create a [metadata import file](https://cloud.google.com/dataplex/docs/import-metadata#components) for Google Dataplex. 
...
Entries generated by this connector confirm to the Snowflake FQN defined in the [Dataplex Documentation for FQN](https://cloud.google.com/dataplex/docs/fully-qualified-names#predefined-snowflake)
