...
def generate_import(file_path : str, output_filename : str, project : str, location : str):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--project",type=str,default=None,help="Name of output file (optional)")
    parser.add_argument("--location",type=str,default=None,help="Name of output file (optional)")
    args = parser.parse_args()

    generate_import(args.file_path,args.output_filename, arg.project, arg.location )
