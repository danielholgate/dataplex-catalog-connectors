...
Fully Qualified Names for entries generated by this connector confirm to the MySQL FQN defined in the [Dataplex Documentation for FQN](https://cloud.google.com/dataplex/docs/fully-qualified-names#predefined-mysql)
